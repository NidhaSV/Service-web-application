        ...
        <div class="search">
          <div class="autocomplete" >
                <form name="frm" action="takeme.php"  method="POST">
                    <input type="text" placeholder="   servics | location "  id="searchInput"  name="searchInput"   size="100"> 
                    <button type="submit"  >
                      <div class="icon">
...
<script>
    ...
    <script>
      ...
      /*An array containing all the service categories:*/
      var service_categories = [
        "Painter", "Carpenter", "Pest control", "Plumber", "Driver", "Electrician",
        "Cleaner", "House hold cleaner", "TV repair", "Auto Mechanic", "Aoto Battery service",
        "Lock smith", "Packers & Movers", "Car Mechanic"];
      
      /*initiate the autocomplete function on the "searchInput" element, and pass along the categories array as possible autocomplete values:*/
      autocomplete(document.getElementById("searchInput"), service_categories);
    </script>
